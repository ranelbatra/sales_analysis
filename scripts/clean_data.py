import numpy as np
import pandas as pd
df=pd.read_csv('C:\\Users\\HP\\sales_analysis\\data\\iowa_liquor_sales_target_raw.csv')
...
df['vendor_name']=df['vendor_name'].str.strip().str.replace('MCCORMICK DISTILLING COMPANY', 'MCCORMICK DISTILLING COMPANY')
...
print(df.groupby('vendor_name')['pack'].value_counts())